...
df = pd.read_excel("C:/Users/tunahan/Desktop/makaleee/kayit2.xlsx")
...
def prepare_dataset(batch):
    ...
    batch["labels"] = tokenizer(batch["metin"]).input_ids
    return batch
...
class DataCollatorSpeechSeq2SeqWithPadding:
    ...
    def __call__(self, features: List[Dict[str, Union[List[int], torch.Tensor]]]) -> Dict[str, torch.Tensor]:
        ...
        batch["input_features"] = batch["input_features"].to("cuda")
